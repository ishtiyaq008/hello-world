...
<dl>
 ...
 <dt><a href="/en-US/docs/Web/Progressive_web_apps">Progressive web apps (PWAs)</a></dt>
...
<dl>
 ...
 <dd>Reference material for each of the individual APIs that comprise the Web's powerful scriptability, including the DOM and all of the related APIs and interfaces you can use to build Web content and apps.</dd>
